...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 22, 2022 at 11:50 PM
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `Get_All_Task_Count_On_Status_Based_On_Project` (IN `projectID` VARCHAR(4))  select TaskName,
   sum(case when task_status = 'New' then 1  else 0 end) as New,  -- only count status New
   sum(case when task_status = 'Done' THEN 1 else 0 end) as Completed,-- only count status Completed
...
(8, 'testing 1234', '2022-09-21', 'New', 0, 0, 4, 2, 1, '2022-09-19 10:28:37', '2022-09-19 10:28:37'),
(9, 'testing 1234', '2022-09-30', 'New', 0, 0, 4, 4, 1, '2022-09-19 10:29:24', '2022-09-19 10:29:24'),
(10, 'testing 1234', '2022-09-30', 'New', 0, 0, 4, 2, 1, '2022-09-19 10:30:17', '2022-09-19 10:30:17'),
(12, 'Task Test', '2022-09-23', 'New', 0, 0, 4, 2, 1, '2022-09-22 08:31:19', '2022-09-21 19:00:00'),
(13, 'Task Digital Marketing', '2022-09-30', 'Done', 1, 100, 4, 3, 1, '2022-09-22 08:41:50', '2022-09-21 19:00:00');
...
--
ALTER TABLE `tasks`
  MODIFY `task_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
